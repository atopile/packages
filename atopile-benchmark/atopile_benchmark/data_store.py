...
from .benchmark_runner import BenchmarkResult, BuildPhase
    ...
    def get_summary_statistics(self) -> dict[str, Any]:
        ...
        for result in all_results:
            ...
            if version_id not in by_version:
                by_version[version_id] = {"success": 0, "failure": 0, "stub": 0, "times": []}
        ...
        for version_id, stats in by_version.items():
            ...
            stats["total"] = stats["success"] + stats["failure"] + stats["stub"]
        ...
        for result in all_results:
            ...
            if benchmark not in by_benchmark:
                by_benchmark[benchmark] = {"success": 0, "failure": 0, "stub": 0, "times": []}
        ...
        return {
            ...
            "success_rate": (len(success_results) / len(all_results) * 100) if all_results else 0.0,
    ...
    def get_version_comparison(self) -> list[dict]:
        ...
        for version_id, data in version_data.items():
            ...
            comparisons.append({
                ...
                "success_rate": (data["success_count"] / data["total_count"] * 100) if data["total_count"] else 0,
