...
module Usage:
    ...
    # I2C interfaces (would connect to your microcontroller and sensor)
    i2c_side1 = new I2C
    i2c_side2 = new I2C

    # Configure I2C frequency
    assert i2c_side1.frequency <= 400kHz
    assert i2c_side2.frequency <= 400kHz

    # I2C Connections
    i2c_side1 ~ isolator.i2cs[0]
    i2c_side2 ~ isolator.i2cs[1]
