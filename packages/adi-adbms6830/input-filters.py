...
class ADBMS6830InputFilters(Module):
    ...
    class SenseFilter(Module):
        def __init__(
            self,
            sense_filter_resistance: Quantity_Interval,
            sense_filter_capacitance: Quantity_Interval,
        ):
            super().__init__()
    ...
    class BalanceFilter(Module):
        def __init__(
            self,
            bleed_resistance_target: float,
            bleed_filter_capacitance: Quantity_Interval,
        ):
            super().__init__()
    ...
    def balance_filters(self) -> list[BalanceFilter]:
        ...
        return times(
            self.number_of_cells,
            lamb=lambda: self.BalanceFilter(
    ...
    def __preinit__(self):
        ...
        self.bottom_sense_filter = self.SenseFilter(
            self.sense_filter_resistance, self.sense_filter_capacitance
        )
