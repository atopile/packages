...
from "packages/sensirion-scd40/scd40.ato" import SCD40_driver, Example

# Minimal wiring example
module Top:
    bus = new I2C
    pwr = new ElectricPower
    sensor = new SCD40_driver

    bus ~ sensor.i2c
    pwr ~ sensor.power
```

See the `Example` module in `scd40.ato` for a complete, runnable example.
