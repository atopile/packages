...
module Usage:
    ...
    module Trinamic_TMC5160_Dev_Board:
        ...
        chip_select.override_net_name = "chip-select"
        spi.sclk.override_net_name = "spi-sclk"
        spi.mosi.override_net_name = "spi-mosi"
        spi.miso.override_net_name = "spi-miso"
        clk.override_net_name = "clk"
        drive_enable.override_net_name = "n-drive-enable"
        refl_step.override_net_name = "refl_step"
        refr_dir.override_net_name = "refr_dir"

        power_motor.override_net_name = "power-motor"
        power_motor.lv.override_net_name = "gnd"
        motor_a1.override_net_name = "motor-a1"
        motor_a2.override_net_name = "motor-a2"
        motor_b1.override_net_name = "motor-b1"
        motor_b2.override_net_name = "motor-b2"
        diag0_swn.override_net_name = "diag0_swn"
        enca_dcin_cfg5.override_net_name = "enca_dcin_cfg5"
        encb_dcen_cfg4.override_net_name = "encb_dcen_cfg4"
        encn_dco_cfg6.override_net_name = "encn_dco_cfg6"
