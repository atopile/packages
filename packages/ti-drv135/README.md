# TI DRV135 — Line-Level Balanced Audio Driver

Balanced line driver for audio applications. Provides differential outputs with sense/force pins; supports external decoupling and output protection.
